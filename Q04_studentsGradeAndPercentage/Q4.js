...
function studentsGradeAndPercentage(marks) {
...
;
//Student got given marks in all subjects:
const studentMarks = [90, 79, 70, 65, 50, 85];
const { grade, percentage } = studentsGradeAndPercentage(studentMarks);
console.log(`The student scored ${percentage.toFixed(2)}% and got a grade of ${grade}`);
export {};
